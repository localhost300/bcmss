  ...
  return (
    <div className="flex min-h-screen flex-col gap-6 bg-gray-50 p-6 text-gray-900">
        ...
        <div className="flex flex-col gap-3 lg:flex-row lg:items-end">
          <div className="flex flex-col">
            ...
            <select
              ...
              className="mt-1 w-52 rounded-md border border-gray-300 px-2 py-1.5 text-xs text-gray-900 focus:border-lamaSky focus:outline-none focus:ring-1 focus:ring-lamaSky"
            >
          ...
          <div className="flex flex-col">
            ...
            <input
              value={termScope}
              disabled
              className="mt-1 w-40 rounded-md border border-gray-300 bg-gray-100 px-2 py-1.5 text-[11px] text-gray-600"
            />
          </div>
          <div className="flex flex-col">
            <label className="text-xs font-semibold text-gray-500">
            ...
            <select
              ...
              className="mt-1 w-56 rounded-md border border-gray-300 px-2 py-1.5 text-xs text-gray-900 focus:border-lamaSky focus:outline-none focus:ring-1 focus:ring-lamaSky"
            >
          ...
          <div className="flex flex-col">
            ...
            <select
              ...
              className="mt-1 w-64 rounded-md border border-gray-300 px-2 py-1.5 text-xs text-gray-900 focus:border-lamaSky focus:outline-none focus:ring-1 focus:ring-lamaSky"
      ...
      {report ? (
        <div
          ref={printRef}
          className="mx-auto w-full max-w-[210mm] bg-white p-5 text-gray-900 shadow-lg text-[13px] leading-tight"
        >
          <section className="flex items-center gap-3 border-b border-gray-300 pb-3">
          ...
          <section className="mt-4 border border-gray-300">
            <div className="grid grid-cols-1 divide-y divide-gray-300 text-xs md:grid-cols-2 md:divide-y-0 md:divide-x">
                ...
                <tbody>
                  {psychomotorTraits.length ? (
                    psychomotorTraits.map((trait) => (
                      ...
                      >
                        <td className="px-2 py-1.5">{trait.trait}</td>
                        <td className="px-2 py-1.5 text-center">{trait.score}</td>
                    ...
                    <tr>
                      <td className="px-2 py-1.5 text-[11px] text-gray-500" colSpan={3}>
          ...
          <section className="mt-6 grid grid-cols-1 gap-3 lg:grid-cols-2">
            <div className="flex flex-col gap-2">
              ...
              <textarea
                ...
                className="min-h-[90px] w-full rounded-md border border-gray-300 px-2 py-1.5 text-xs text-gray-900 focus:border-lamaSky focus:outline-none focus:ring-1 focus:ring-lamaSky"
              />
          ...
          <section className="mt-6 flex flex-col gap-3 border-t border-gray-300 pt-4 text-xs">
            <div className="flex gap-6">
              <label className="flex items-center gap-3 font-semibold">
                ...
                <input
                  ...
                  className="rounded-md border border-gray-300 px-2 py-1.5 text-xs text-gray-900 focus:border-lamaSky focus:outline-none focus:ring-1 focus:ring-lamaSky"
                />
              </label>
